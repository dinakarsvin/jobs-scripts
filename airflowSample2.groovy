job('Astro Docker example 2') {
    ...
    steps {
		 ...
		 shell("docker build -t registry.gcp0001.us-east4.astronomer.io/elementary-flyby-8509/airflow:ci-3 .")
		 
		 shell("docker push registry.gcp0001.us-east4.astronomer.io/elementary-flyby-8509/airflow:ci-3")
		 
		 shell("echo 'Build Completed for second'")
